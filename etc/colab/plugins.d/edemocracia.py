...
settings_variables = {
    ...
    'SOCIAL_AUTH_CAMARA_DEPUTADOS_KEY': 'edemocracia',
    'SOCIAL_AUTH_CAMARA_DEPUTADOS_SECRET': 'edemocracia1234',
    'SOCIAL_AUTH_CAMARA_DEPUTADOS_VERIFY_SSL': 'False',
    'CAMARA_DEPUTADOS_AUTHORIZATION_URL': '',
    'CAMARA_DEPUTADOS_ACCESS_TOKEN_URL': '',
    'CAMARA_DEPUTADOS_METADATA_URL': '',
}
